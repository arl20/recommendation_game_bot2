...
from utils.functions_for_recommendation import get_key, get_link, load_data, get_popular_recommendations, get_new_recommendations, load_user_data
...
async def add_game(chosen_result: ChosenInlineResult, bot, state: FSMContext, games_info_dict_by_name: dict, 
    ...
    if user_id not in user_data:
         user_data = await asyncio.to_thread(load_user_data, user_data, user_id)
